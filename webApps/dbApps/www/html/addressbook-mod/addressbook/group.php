...
<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
    <!--
    <input type="button" name="new" value="<?php echo ucfmsg('NEW_GROUP'); ?>" />
    <input type="button" name="delete" value="<?php echo ucfmsg('DELETE_GROUPS'); ?>" />
	<input type="button" name="edit" value="<?php echo ucfmsg('EDIT_GROUP'); ?>" />
    -->
<hr />
