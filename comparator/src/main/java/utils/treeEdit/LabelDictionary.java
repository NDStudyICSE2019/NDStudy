...
public class LabelDictionary {
	...
	/**
	 * Adds a new label to the dictionary if it has not been added yet. Returns the
	 * ID of the new label in the dictionary.
	 * 
	 * @param label
	...
	/**
	 * @param newLabelsAllowed
	 *            the newLabelsAllowed to set
	 */
