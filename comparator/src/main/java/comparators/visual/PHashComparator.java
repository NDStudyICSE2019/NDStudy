...
public class PHashComparator extends VisualAbstractComparator {

	private String name = "VISUAL-PHash";
	private Mat page1;
	private Mat page2;

	public PHashComparator() {
		super();
	}

	public PHashComparator(Mat p1, Mat p2) {
		super();
		setPage1(p1);
		setPage2(p2);
	}
	...
	public double computeDistance() {
		...
		PHash.create().compute(page1, hash1);
		PHash.create().compute(page2, hash2);
